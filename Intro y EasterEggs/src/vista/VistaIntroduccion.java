...
public class VistaIntroduccion {
	...
	static int esperaLinea = 1000;//Atributo que se utiliza para fijar la espera entre una linea y otra
	...
	public static void mostrarFase1 () throws  InterruptedException{//Muestra la introduccion a la primera fase
		...
		//Párrafo 3
		Limpiar.clear();
		System.out.println("Empiezas a gritar la palabra clave “Terminar instancia”, pero la sesión no se cierra, permaneces en el mismo sitio sentado y anonanado, ya que");
		Thread.sleep(esperaLinea);
		Limpiar.clear();
		System.out.println("Empiezas a gritar la palabra clave “Terminar instancia”, pero la sesión no se cierra, permaneces en el mismo sitio sentado y anonanado, ya que\n"
	...
	public static void mostrarConversacion (String jugador) throws  InterruptedException{//Muestra la introduccion la conversación con Angel con el nombre personalizado asignado como "jugador"
		...
		EsperaDeLectura.esperaDeLectura();
		Limpiar.clear();
		System.out.println("- " + jugador +": Vale muy bien, ¿Eres un virus o qué? ¿Has venido de regalo con el último parche o qué?");
		Thread.sleep(esperaLinea);
		EsperaDeLectura.esperaDeLectura();
		Limpiar.clear();
		...
		EsperaDeLectura.esperaDeLectura();
		Limpiar.clear();
		System.out.println("Miras detenidamente el aparato: es un smartphone negro simple y sin marca alguna, con una cámara detrás. En la pantalla solo hay una lista");
		Thread.sleep(esperaLinea);
		Limpiar.clear();
		System.out.println("Miras detenidamente el aparato: es un smartphone negro simple y sin marca alguna, con una cámara detrás. En la pantalla solo hay una lista"
				+ "vacía y dos botones: Escanear e Instanciar.");
		Thread.sleep(esperaLinea);
		EsperaDeLectura.esperaDeLectura();
		Limpiar.clear();
