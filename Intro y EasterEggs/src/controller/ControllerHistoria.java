...
public class ControllerHistoria {
	...
	public void comprobarPEasterEgg(char[][] mapa, int fase) {
		...
		if (mapa[13][1] == 'P' && fase != 4) {//puerta hacia fuera cerrada
			mapa[13][1] = '?';
		}
		if (mapa[14][1] == 'P' && fase != 4) {//puerta hacia fuera cerrada
			mapa[14][1] = '?';
		}
		if (mapa[13][1] == 'P' && fase == 4) {//puerta hacia fuera abierta
			mapa[13][1] = '?';
		}
		if (mapa[14][1] == 'P' && fase == 4) {//puerta hacia fuera abierta
			mapa[14][1] = '?';
		}
		if (mapa[16][3] == 'P') {//puerta hacia 2º
			mapa[16][3] = '?';
		}
		if (mapa[16][2] == 'P') {//puerta hacia 2º
			mapa[16][2] = '?';
		}
