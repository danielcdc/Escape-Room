...
public class Jugabilidad {
	...
	public void comprobarGanadorJugador(Util ut1,jugador3Raya listaJugadores[]) {
	...
	public void comprobarGanadorEnemigo(Util ut1,jugador3Raya listaJugadores[]) {
		int cero=0,uno=1,dos=2,tres=3,cuatro=4,cinco=5,seis=6,siete=7,ocho=8;
	...
	public boolean comprobarRepetir(Util ut1, jugador3Raya listaJugadores[],int posicion,int numeroJugador) {
