...
System.out.println("Bienvenido a este juego, las normas son mas simples que hacer"
		+ " una variable, tu deber es completar la siguiente cerradura, teniendo en"
		+ "cuenta:");
System.out.println("2.La multiplicación de todas las linas del array deve dar el mismo "
				+ "resultado");
System.out.println("3.No puedes colocar 2 veces el mismo numero");
System.out.println("4.Si no consigues pasar el minijuego optendras subconsultas...es broma"
		+ "ni yo soy tan malo simplemente por cada vez que falles mataremos un gatito :) ");
		
	}
public void imprimirCerradura(Datos d) {
		
	System.out.println("[" + d.getCerradura()[0] + "]   " + "[" + d.getCerradura()[1] + "]");
	System.out.println("[" + d.getCerradura()[2] + "]" + "[" + d.getCerradura()[3] + "]" + "[" 
	+ d.getCerradura()[4] + "]");
...
public void imprimirEjemplo(Datos d) {
	...
	System.out.println("[" + d.getNumerador()[2] + "]" + "[" + d.getNumerador()[3] + "]" + "[" 
	+ d.getNumerador()[4] + "]");
