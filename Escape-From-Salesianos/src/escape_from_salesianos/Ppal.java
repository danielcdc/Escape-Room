...
public class Ppal {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Cargamos los datos, vistas y controladores.
		Datos d = new Datos();
		boolean ganad = false;
		...
		/*
		 * VA CON ESTO LA OPT1 COMO PRUEBA PARA LEER SOLO DANDO INTRO opt1 =
		 * Leer.dato(); if(opt1.equalsIgnoreCase("")) { System.out.println("Funciona");
		 * } else { System.out.println("chupala"); }
		 */
		...
		do {
			...
			case 1:
				...
				do {
					...
					cHistory.ejecutarPrueba(mov, mapaHistoria.getD().getMapaClase(), mapaHistoria.getD().getFase(), d,
							cMapa, vM, vMapa, mapaHistoria, cJP, intro);
